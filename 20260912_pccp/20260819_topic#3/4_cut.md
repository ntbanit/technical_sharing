...
#### Ví dụ #1 : Hình ảnh dưới đây minh họa một cách giải quyết cho dữ liệu đầu vào đã cho.
...
#### Ví dụ Đầu vào/Đầu ra #2: Hình ảnh dưới đây minh họa phương pháp giải quyết cho dữ liệu đầu vào đã cho.
<img src="4_ex2.png" width="500">

#### Việc cắt đường dây nối trạm 2 và trạm 3 dẫn đến kết quả là mỗi lưới điện đều có hai trạm; đây là cách tiếp cận tối ưu. 


#### Ví dụ về Đầu vào/Đầu ra số 3 : Hình ảnh dưới đây minh họa phương pháp giải quyết cho dữ liệu đầu vào đã cho.
<img src="4_ex3.png" width="500">
